...
namespace RU.Tinkoff.Acquiring.Sdk.Requests {
	...
	public partial class AcquiringRequest : global::Java.Lang.Object {
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.requests']/class[@name='AcquiringRequest']/field[@name='CHARGE_FLAG']"
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.requests']/class[@name='AcquiringRequest']/field[@name='DATA']"
		[Register ("DATA")]
		...
		static IntPtr IGNORED_FIELDS_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.requests']/class[@name='AcquiringRequest']/field[@name='IGNORED_FIELDS']"
		[Register ("IGNORED_FIELDS")]
		public static global::System.Collections.ICollection IgnoredFields {
			get {
				if (IGNORED_FIELDS_jfieldId == IntPtr.Zero)
					IGNORED_FIELDS_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "IGNORED_FIELDS", "Ljava/util/Set;");
				IntPtr __ret = JNIEnv.GetStaticObjectField (class_ref, IGNORED_FIELDS_jfieldId);
				return global::Android.Runtime.JavaSet.FromJniHandle (__ret, JniHandleOwnership.TransferLocalRef);
			}
		}

		static IntPtr IGNORED_FIELDS_VALUES_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.requests']/class[@name='AcquiringRequest']/field[@name='IGNORED_FIELDS_VALUES']"
		[Register ("IGNORED_FIELDS_VALUES")]
		public static IList<string> IgnoredFieldsValues {
			get {
				if (IGNORED_FIELDS_VALUES_jfieldId == IntPtr.Zero)
					IGNORED_FIELDS_VALUES_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "IGNORED_FIELDS_VALUES", "[Ljava/lang/String;");
				return global::Android.Runtime.JavaArray<string>.FromJniHandle (JNIEnv.GetStaticObjectField (class_ref, IGNORED_FIELDS_VALUES_jfieldId), JniHandleOwnership.TransferLocalRef);
			}
		}
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.requests']/class[@name='AcquiringRequest']/field[@name='RECEIPT']"
		[Register ("RECEIPT")]
		public const string Receipt = (string) "Receipt";
...
#pragma warning restore 0169
		...
		public virtual unsafe global::System.Collections.Generic.IDictionary<string, global::Java.Lang.Object> AsMap ()
		{
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					return global::Android.Runtime.JavaDictionary<string, global::Java.Lang.Object>.FromJniHandle (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_asMap), JniHandleOwnership.TransferLocalRef);
				else
					return global::Android.Runtime.JavaDictionary<string, global::Java.Lang.Object>.FromJniHandle (JNIEnv.CallNonvirtualObjectMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "asMap", "()Ljava/util/Map;")), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}

		static Delegate cb_putIfNotNull_Ljava_lang_String_Ljava_lang_Object_Ljava_util_Map_;
#pragma warning disable 0169
		static Delegate GetPutIfNotNull_Ljava_lang_String_Ljava_lang_Object_Ljava_util_Map_Handler ()
		{
			if (cb_putIfNotNull_Ljava_lang_String_Ljava_lang_Object_Ljava_util_Map_ == null)
				cb_putIfNotNull_Ljava_lang_String_Ljava_lang_Object_Ljava_util_Map_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr, IntPtr, IntPtr>) n_PutIfNotNull_Ljava_lang_String_Ljava_lang_Object_Ljava_util_Map_);
			return cb_putIfNotNull_Ljava_lang_String_Ljava_lang_Object_Ljava_util_Map_;
		}

		static void n_PutIfNotNull_Ljava_lang_String_Ljava_lang_Object_Ljava_util_Map_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0, IntPtr native_p1, IntPtr native_p2)
		{
			global::RU.Tinkoff.Acquiring.Sdk.Requests.AcquiringRequest __this = global::Java.Lang.Object.GetObject<global::RU.Tinkoff.Acquiring.Sdk.Requests.AcquiringRequest> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		static IntPtr id_putIfNotNull_Ljava_lang_String_Ljava_lang_Object_Ljava_util_Map_;
		// Metadata.xml XPath method reference: path="/api/package[@name='ru.tinkoff.acquiring.sdk.requests']/class[@name='AcquiringRequest']/method[@name='putIfNotNull' and count(parameter)=3 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.Object'] and parameter[3][@type='java.util.Map&lt;java.lang.String, java.lang.Object&gt;']]"
		[Register ("putIfNotNull", "(Ljava/lang/String;Ljava/lang/Object;Ljava/util/Map;)V", "GetPutIfNotNull_Ljava_lang_String_Ljava_lang_Object_Ljava_util_Map_Handler")]
		protected virtual unsafe void PutIfNotNull (string p0, global::Java.Lang.Object p1, global::System.Collections.Generic.IDictionary<string, global::Java.Lang.Object> p2)
		{
			if (id_putIfNotNull_Ljava_lang_String_Ljava_lang_Object_Ljava_util_Map_ == IntPtr.Zero)
				id_putIfNotNull_Ljava_lang_String_Ljava_lang_Object_Ljava_util_Map_ = JNIEnv.GetMethodID (class_ref, "putIfNotNull", "(Ljava/lang/String;Ljava/lang/Object;Ljava/util/Map;)V");
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_putIfNotNull_Ljava_lang_String_Ljava_lang_Object_Ljava_util_Map_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "putIfNotNull", "(Ljava/lang/String;Ljava/lang/Object;Ljava/util/Map;)V"), __args);
			} finally {
