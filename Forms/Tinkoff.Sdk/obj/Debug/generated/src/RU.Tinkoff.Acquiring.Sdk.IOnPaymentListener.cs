...
namespace RU.Tinkoff.Acquiring.Sdk {
	...
	public partial interface IOnPaymentListener : IJavaObject {
		...
		[Register ("onCancelled", "()V", "GetOnCancelledHandler:RU.Tinkoff.Acquiring.Sdk.IOnPaymentListenerInvoker, Tinkoff.Sdk")]
		void OnCancelled ();
		...
		[Register ("onError", "(Ljava/lang/Exception;)V", "GetOnError_Ljava_lang_Exception_Handler:RU.Tinkoff.Acquiring.Sdk.IOnPaymentListenerInvoker, Tinkoff.Sdk")]
		...
		[Register ("onSuccess", "(J)V", "GetOnSuccess_JHandler:RU.Tinkoff.Acquiring.Sdk.IOnPaymentListenerInvoker, Tinkoff.Sdk")]
